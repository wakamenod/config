:PROPERTIES:
:ID:       649609AD-9832-4477-8511-748EA47A6709
:END:
#+title: Aqua SKK
...
* keymap.conf
#+begin_src text :tangle ~/Library/Application Support/AquaSKK/keymap.conf
###
### keymap.conf
###
...
* For symbols such as !
#+begin_src text :tangle ~/Library/Application Support/AquaSKK/symbols.rule
### -*- coding: euc-jp-unix -*-
!,！,！,!
?,？,？,?
/,・,・,・
